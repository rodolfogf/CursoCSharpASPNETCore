...
using SalesWebMVC.Models;  //Apesar de estar na mesma pasta, o SalesWebMCVContext está em outro namespace
...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        /*Faz a injeção de dependência, ou seja:
         Quando um objeto do tipo SeedingService for criado, automaticamente ele também receberá um instância do context
         */
